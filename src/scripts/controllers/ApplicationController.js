...
export default class ApplicationController extends BindableController {
    ...
    constructor(element) {
        ...
        this._getAppConfiguration(configUrl, (err, _configuration) => {
            ...
            this.configuration = ApplicationController._prepareConfiguration(_configuration, basePath);
    ...
    static _prepareConfiguration(rawConfig, websiteBase) {
        ...
        configuration.pagesHierarchy = ApplicationController._prepareRoutesTree(configuration.routes, historyType);
